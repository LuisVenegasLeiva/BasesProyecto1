 ...
 * @author mrluis137
 */
public class MisSubastas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Filtro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nada", "Completas", "SIn completar" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MisSubastas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MisSubastas().setVisible(true);
            }
        });
    }
